...
public class ColourExportTests
{
	...
	public void Colour_ShouldExport_BaseCharactersOnly(CharColourMode colour, bool rrb)
	{
		// setup
		...
		// verify
		var testDataCreator = new ResourcesCreator.ExpectedColourCreator()
			.Colour(colour)
			.RRB(rrb)
			.RunChars();
	...
	[InlineData(CharColourMode.NCM, false)]
	[InlineData(CharColourMode.NCM, true)]
	public void Colour_ShouldExport_ColourCharactersOnly(CharColourMode colour, bool rrb)
	{
		// setup
		var data = new DataContainerCreator()
			.Colour(colour)
	...
	[InlineData(CharColourMode.NCM, false)]
	[InlineData(CharColourMode.NCM, true)]
	public void Colour_ShouldExport_BaseAndColourCharacters(CharColourMode colour, bool rrb)
	{
		// setup
		var data = new DataContainerCreator()
			.Colour(colour)
