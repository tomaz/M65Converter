...
public abstract class PaletteMerger
{
	...
	/// 
	/// Subclass should merge all image colours into the given palette. The images and other data is available from the <see cref="Options"/>.
	/// </summary>
	protected abstract void OnMerge(List<ColourData> palette);
	...
	public class OptionsType
	{
		...
		/// <summary>
		/// The list of all groups of images that need to be added to the same palette bank.
		/// </summary>
		public IReadOnlyList<ImageGroupData> SamePaletteBankImages { get; init; } = null!;
	}
