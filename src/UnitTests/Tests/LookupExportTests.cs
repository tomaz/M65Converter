...
public class LookupExportTests
{
	...
	public void Lookup__ShouldExport__Base(CharColourMode colour, bool rrb)
	{
		// setup
		...
		// verify
		var testDataCreator = testData.GetLookupDataCreator();
	...
	[InlineData(CharColourMode.NCM, false)]
	[InlineData(CharColourMode.NCM, true)]
	public void Lookup__ShouldExport__Screen(CharColourMode colour, bool rrb)
	{
		// setup
		var testData = new TestDataCreator()
			.Colour(colour)
	...
	[InlineData(CharColourMode.NCM, false)]
	[InlineData(CharColourMode.NCM, true)]
	public void Lookup__ShouldExport__Screen_Sprites(CharColourMode colour, bool rrb)
	{
		// setup
		var testData = new TestDataCreator()
			.Colour(colour)
	...
	[InlineData(CharColourMode.NCM, false)]
	[InlineData(CharColourMode.NCM, true)]
	public void Lookup__ShouldExport__Base_Screen(CharColourMode colour, bool rrb)
	{
		// setup
		var testData = new TestDataCreator()
			.Colour(colour)
	...
	[InlineData(CharColourMode.NCM, false)]
	[InlineData(CharColourMode.NCM, true)]
	public void Lookup__ShouldExport__Base_Screen_Sprites(CharColourMode colour, bool rrb)
	{
		// setup
		var testData = new TestDataCreator()
			.Colour(colour)
