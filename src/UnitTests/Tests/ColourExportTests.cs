...
public class ColourExportTests
{
	...
	[InlineData(CharColourMode.NCM, false)]
	[InlineData(CharColourMode.NCM, true)]
	public void Colour_ShouldExport_ScreenCharactersOnly(CharColourMode colour, bool rrb)
	{
		// setup
		var testData = new TestDataCreator()
			.Colour(colour)
	...
	[InlineData(CharColourMode.NCM, false)]
	[InlineData(CharColourMode.NCM, true)]
	public void Colour_ShouldExport_BaseAndScreenCharacters(CharColourMode colour, bool rrb)
	{
		// setup
		var testData = new TestDataCreator()
			.Colour(colour)
